...
export const COMMANDS: Command[] = [
  ...
  // Time range (map overlay: UAP and other time-filtered layers; filter by occurred date)
  { id: 'time:1d', keywords: ['1d', '1 day', 'last day'], label: 'Show events from last day', icon: '\u{1F550}', category: 'actions' },
  { id: 'time:7d', keywords: ['7d', 'week', 'last week', '7 days'], label: 'Show events from last 7 days', icon: '\u{1F55B}', category: 'actions' },
  { id: 'time:30d', keywords: ['30d', '30 days', 'last month'], label: 'Show events from last 30 days', icon: '\u{1F55C}', category: 'actions' },
  { id: 'time:6m', keywords: ['6m', '6 months', 'half year'], label: 'Show events from last 6 months', icon: '\u{1F4C5}', category: 'actions' },
  { id: 'time:1y', keywords: ['1y', '1 year', 'last year'], label: 'Show events from last year', icon: '\u{1F5D3}\uFE0F', category: 'actions' },
  { id: 'time:all', keywords: ['all', 'all time', 'no filter'], label: 'Show all time', icon: '\u{1F551}', category: 'actions' },
];
